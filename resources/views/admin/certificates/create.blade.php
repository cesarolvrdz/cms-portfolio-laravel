...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted">Agrega un nuevo certificado o curso a tu portafolio</p>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror"
                                      ...
                                      name="description"
                                      rows="3"
                                      placeholder="Describe lo que aprendiste o las habilidades desarrolladas...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('category') is-invalid @enderror"
                                    ...
                                    <option value="data" {{ old('category') == 'data' ? 'selected' : '' }}>Datos y Analytics</option>
                                    <option value="cloud" {{ old('category') == 'cloud' ? 'selected' : '' }}>Cloud Computing</option>
                                    <option value="security" {{ old('category') == 'security' ? 'selected' : '' }}>Seguridad</option>
                                    <option value="management" {{ old('category') == 'management' ? 'selected' : '' }}>Gestión de Proyectos</option>
                                ...
                                <div class="form-text">O escribe una nueva categoría personalizada</div>
                                @error('category')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file"
                                   ...
                                   name="image"
                                   accept="image/*">
                            <div class="form-text">Imagen que representa el conocimiento adquirido (máx. 2MB)</div>
                            @error('image')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file"
                                   ...
                                   name="pdf"
                                   accept=".pdf">
                            <div class="form-text">Archivo PDF del certificado (máx. 10MB)</div>
                            @error('pdf')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
